...
class generic_paraH2COmodel(object):
    ...
    def grid_getmatch_404to303(self, ratio, eratio, chi2_thresh=1):
    ...
    def grid_getmatch_422to404(self, ratio, eratio, chi2_thresh=1):
    ...
    def grid_getmatch_423to404(self, ratio, eratio, chi2_thresh=1):
